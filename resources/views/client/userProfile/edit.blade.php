            ...
            <x-app-layout>
                ...
                <div class="container w-1/2 text-gray-800 mx-auto p-4 shadow-lg mt-6">
                    <form action="{{ route('userProfile.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="fullname" name="fullname" value="{{ old('fullname', $userProfile->fullname) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                            @error('fullname')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" id="phone" name="phone" value="{{ old('phone', $userProfile->phone) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                            @error('phone')
                                <p class="text-red-600 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Date of Birth Field -->
                        <div class="mb-4">
                            <label for="DOB" class="block text-sm font-medium text-gray-100">Age</label>
                            <input type="date" id="DOB" name="DOB" value="{{ old('DOB', $userProfile->DOB) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                            @error('DOB')
                                <p class="text-red-600 text-sm">{{ $message }}</p>
                            @enderror
                        </div>
