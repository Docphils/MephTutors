<x-app-layout>
    ...
    <div class="py-12">
        <div class="mx-auto mb-4 text-right mx-6">
            <a wire:navigate href="{{ route('client.tutorRequests.create') }}" class="mx-6 text-cyan-900 bg-cyan-300 p-1 rounded-sm font-semibold shadow-lg shadow-cyan-600">Make New Request</a>
        </div>
