    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="bg-cyan-900 p-6 text-white">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-2xl font-bold">Coding Tutor Request Submission</h1>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <p>A request for coding tutor has been submitted and needs your prompt attention. See details below:</p>

            <!-- Request Details -->
            <div class="mt-6 bg-gray-50 p-4 rounded-lg shadow">
                <ul class="space-y-2 text-sm">
                    <li><strong>Lesson ID:</strong> {{ $codingRequest['id'] }}</li>
                    <li><strong>Client's Name:</strong> {{ $codingRequest->user->userProfile->fullname }}</li>
                    <li><strong>Location:</strong> {{ $codingRequest['full_address'] }}</li>
                    <li><strong>Subjects:</strong> {{ $codingRequest['class_type'] }}</li>
                </ul>
            </div>
