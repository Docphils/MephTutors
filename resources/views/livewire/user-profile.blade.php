        ...
        @else
            ...
            @if ($userProfile)
                <div class="sm:text-center mb-4">
                    ...
                    <button wire:click="edit" class="hidden sm:block bg-cyan-600 hover:bg-cyan-800 text-white sm:px-2 sm:py-1 rounded-md text-xs sm:text-sm">Update profile</button>
                </div>
                @else
