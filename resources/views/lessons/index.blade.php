<x-app-layout>
    ...
    <div class="py-12">
        ...
        <!--Active Lessons-->
        <div class="text-cyan-50 text-3xl mb-4 mx-16">Active Lessons</div>
        <div class="max-w-7xl grid sm:grid-cols-2 gap-8 mx-auto sm:px-6 lg:px-8 my-6">
        ...
        <!--Closed Lessons Section-->

        <div class="text-cyan-50 text-3xl mb-4 mx-16">Completed or Closed Lessons</div>
        <div class="max-w-7xl grid sm:grid-cols-2 gap-8 mx-auto sm:px-6 lg:px-8 my-6">
            @foreach($closedLessons as $lesson)
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-4">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h3 class="text-lg font-semibold">{{ $lesson->subjects }}</h3>
                        <div class="flex justify-between">
